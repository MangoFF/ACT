...
MODEL_PATH = os.environ.get('MODEL_PATH', '/share/home/wg/scpo/model/glm-4-9b')
...
def batch(
    ...
    for input_ids in batched_inputs.input_ids:
        input_format = tokenizer.decode(input_ids, skip_special_tokens=False).strip()
        print(input_format)
...
if __name__ == "__main__":
    ...
    print(f"The mas input tokens is {max_input_tokens}")
    gen_kwargs = {
